...
tf.app.flags.DEFINE_string("ckpt_dir", "../ckpt/ckpt-017", "check point directory.")
tf.app.flags.DEFINE_string("summary_dir", "../summary/summary-017", "summary data directory.")
